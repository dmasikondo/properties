<div>
            <div>
                ...
                <x-jet-input id="password" class="block w-7/12 mx-auto p-2 m-4"  required  placeholder="Search by Town, Price, Residential/Commercial, Area in sqauare m" wire:model.lazy="searchTerm"/>
            </div>
